...
public class Principal {
	...
	public static void main(String[] args) {
		 ...
		 * System.out.print("Name: "); sc.nextLine(); // Limpar quebra de linha dobuffer
		 * String name = sc.nextLine(); System.out.print("Email: "); String email =
		 ...
		 * String.valueOf(x).startsWith("100")).findFirst().orElse(null);// Retorna //
		 * //nulopois // // // nao // // // existe
		 * System.out.println("Primeiro numero que inicie com 1: " + um);
		 ...
		 * System.out.println("Employee #" + (i + 1) + ":"); System.out.print("ID: ");
		 * Integer ID = sc.nextInt(); while (hasID(list, ID)) {
		 * System.out.println("ID alrady taken! Try again"); ID = sc.nextInt(); }
		 * sc.nextLine(); System.out.print("Name: "); String name = sc.nextLine();
		 ...
		 * int idSalary = sc.nextInt(); Employee emp = list.stream().filter(x ->
		 * x.getId() == idSalary).findFirst().orElse(null); // Integer //
		 * pos=position(list, // idSalary); if (emp == null) {
		 * System.out.println("This id does not exist!"); } else {
		 * System.out.print("Enter the percentage: "); double percent = sc.nextDouble();
		 * emp.increaseSalary(percent); }
		 * 
		 * System.out.println(""); System.out.println("List of employee: "); for
		 * (Employee Emplo : list) { System.out.println(Emplo); } }
		 * 
		...
		// Exercicio de matrizes ( fixacao )

		/*
		 * System.out.print("Digite o tamanho da LINHA da matriz: "); int linha =
		 * sc.nextInt(); System.out.print("Digite o tamanho da COLUNA da matriz: "); int
		 * coluna = sc.nextInt(); int[][] matriz = new int[linha][coluna];
		 * 
		 * for (int i = 0; i < matriz.length; i++) { for (int j = 0; j <
		 * matriz[i].length; j++) { matriz[i][j] = sc.nextInt(); } }
		 * 
		 * System.out.print("Entre agora com o numero X: "); int x = sc.nextInt();
		 * 
		 * for (int i = 0; i < matriz.length; i++) { for (int j = 0; j <
		 * matriz[i].length; j++) { if (x == matriz[i][j]) {
		 * System.out.print("\nPosition: " + i + ", " + j); if (j > 0) {
		 * System.out.print("\nLeft: " + matriz[i][j - 1]); } if (i < 0) {
		 * System.out.print("\nUp: " + matriz[i - 1][j]); } if (j < matriz[i].length -
		 * 1) { System.out.print("\nRight: " + matriz[i][j + 1]); } if (i <
		 * matriz[i].length - 1) { System.out.print("\nDown: " + matriz[i + 1][j]); } }
		 * 
		 * } }
		 */
